...
Std_ReturnType lcd_4bit_send_command      (const chr_lcd_4bit_t *lcd, uint8 command){
    ...
    if (NULL == lcd){
        ...
        ret = gpio_pin_write_logic(&(lcd->lcd_rs), PIC_LOW);
...
Std_ReturnType lcd_4bit_send_char_data    (const chr_lcd_4bit_t *lcd, uint8 data){
    ...
    if (NULL == lcd){
        ...
        ret = gpio_pin_write_logic(&(lcd->lcd_rs), PIC_HIGH);
...
static Std_ReturnType lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd){
    Std_ReturnType ret = E_OK;
    ret = gpio_pin_write_logic(&(lcd->lcd_en), PIC_HIGH);
    __delay_us(5);
    ret = gpio_pin_write_logic(&(lcd->lcd_en), PIC_LOW);
    return ret;
}
static Std_ReturnType lcd_4bit_set_cursor        (const chr_lcd_4bit_t *lcd ,uint8 row, uint8 column){
    Std_ReturnType ret = E_OK;
